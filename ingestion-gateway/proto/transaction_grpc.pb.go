...
const (
	TransactionService_SubmitTransaction_FullMethodName = "/transaction.TransactionService/SubmitTransaction"
)
...
func (c *transactionServiceClient) SubmitTransaction(ctx context.Context, in *TransactionRequest, opts ...grpc.CallOption) (*TransactionResponse, error) {
...
func (UnimplementedTransactionServiceServer) SubmitTransaction(context.Context, *TransactionRequest) (*TransactionResponse, error) {
...
func _TransactionService_SubmitTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransactionServiceServer).SubmitTransaction(ctx, req.(*TransactionRequest))
	}
