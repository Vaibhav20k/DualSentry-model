...
export default function Navbar({
  ...
  return (
    <header className="flex justify-between items-center w-full px-lg h-16 sticky top-0 z-40 bg-surface-bright border-b border-outline-variant/20">
      <div className="flex items-center gap-xl flex-1 min-w-0">
        ...
        {/* Search */}
        <div className="flex items-center bg-surface-container-low px-md py-xs rounded-full border border-outline-variant/30 w-full max-w-md">
          <Search
            size={18}
      ...
      <div className="flex items-center gap-md shrink-0">
        ...
        <div className="flex gap-sm border-r border-outline-variant/40 pr-md">
          <button
            ...
            className="p-sm hover:bg-surface-container-low rounded-full transition-colors text-on-surface-variant relative"
          >
            <Bell size={20} />
